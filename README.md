...
If `DATABASE_URL` is not set in `.env`, the app will read it from `connection_string.txt`.
...
This protects uploaded files (`backend/uploads/`) across restarts/redeploys.
